...
const char *argp_program_version = "abridge associateShortNamesToReads 1.2.0";
const char *argp_program_bug_address = "sagnikbanerjee15@gmail.com";
static char doc[] = "associateShortNamesToReads will scan a sam file and output the unique list of alignment tags";
